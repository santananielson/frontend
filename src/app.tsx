...
export function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState([
    'nielsonsantana1@gmail.com', 'nielsonsantana2@gmail.com'
  ])
  ...
  function removeEmailToInvite(email: string) {
    setEmailsToInvite(emailsToInvite.filter((emailToInvite) => {
      return emailToInvite !== email
    }))
  }
        ...
        <div className='space-y-4'>
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              {isGuestsInputOpen ? (
                ...
                <button onClick={openGuestsInput} className="bg-orange-600 text-zinc-50 px-5 py-2 rounded-lg font-medium flex items-center gap-2 hover:bg-orange-500">
                Continuar
            ...
            {isGuestsInputOpen && (
              <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
                ...
                <button  onClick={openConfirmTripModal} className="bg-orange-600 text-zinc-50 px-5 py-2 rounded-lg font-medium flex items-center gap-2 hover:bg-orange-500">
                  Confirmar viagem
                  <ArrowRight  className="size-5 " />
                </button>
              </div>
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
              ...
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2'>
                    ...
                    <button type='button' onClick={() => removeEmailToInvite(email)}><X className='text-zinc-400 size-4'/></button>
                  </div>
                )
              })}
            </div>
            ...
            <form onSubmit={addNewEmailToInvite} className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
              ...
              <button  type='submit' className="bg-orange-600 text-zinc-50 px-5 py-2 rounded-lg font-medium flex items-center gap-2 hover:bg-orange-500">
                Convidar
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
            <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
              ...
              <form onSubmit={addNewEmailToInvite} className='space-y-3'>
                ...
                <button  type='submit' className="bg-orange-600 text-zinc-50 px-5 h-11 rounded-lg font-medium flex items-center gap-2 hover:bg-orange-500 w-full justify-center" >
